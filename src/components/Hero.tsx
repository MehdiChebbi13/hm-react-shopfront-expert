      ...
      <section className="relative h-screen overflow-hidden bg-gray-900">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center">
          ...
          <div className="text-center text-white max-w-3xl px-4">
            <h1 className="font-playfair text-4xl md:text-6xl lg:text-7xl font-medium mb-6 tracking-wide leading-tight">
              Spada Di Battiglia
            </h1>

            <h2 className="font-cormorant text-xl md:text-3xl font-light mb-8 tracking-wider opacity-90 italic">
              L'Arte del Vestire Maschile
            </h2>

            <p className="font-cormorant text-base md:text-lg font-light mb-12 tracking-wide opacity-80 max-w-2xl mx-auto leading-relaxed">
              Depuis trois générations, nous créons des costumes sur mesure qui
              incarnent l'excellence de la tradition sartoriale italienne.
              Chaque pièce est une œuvre d'art, façonnée à la main dans nos
              ateliers de Milan.
            </p>
            ...
            <div className="flex justify-center items-center gap-8 mt-16 opacity-70">
              <div className="text-center">
                <div className="font-playfair text-2xl font-light mb-1">
                  100%
                </div>
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 text-white">
          <div className="flex flex-col items-center animate-bounce">
            ...
            <span className="text-xs font-light tracking-widest uppercase opacity-75">
              Scroll
            </span>
          </div>
        </div>
